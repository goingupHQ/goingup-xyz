...
const HumanCouncilLoginCode = (props) =>
{
    const { code } = props;
            ...
            <Email align="center" headCSS={emailHeadCSS} title={'Human Council x GoingUP Login Code'}>
                ...
                <Item align="center">
                    <Box style={backgroundStyle}>
                        ...
                        <Item style={{ color: '#000' }}>
                            Below is your verification code. Please copy your code and paste it into the app to complete the login process.
                        </Item>
                        <Item style={{ height: 25 }} />
...
export default HumanCouncilLoginCode;
