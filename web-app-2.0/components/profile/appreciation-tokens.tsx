            ...
            title={
              <>
                <Stack
                  ...
                  paddingX={'14px'}
                >
                  <Typography>Appreciation Tokens</Typography>
                  {/* <Button
                    color={
                      app.mode === "dark"
                        ? "primary"
                ...
                >
                  {isReceived ? (
                    ...
                    <Button onClick={handleClick}>Received</Button>
                  )}
                  {isSent ? <Button variant="outlined">Sent</Button> : <Button onClick={handleClick}>Sent</Button>}
                </Stack>
              </>
            }
          />
