...
export interface GoingUpReputationScoreInterface extends utils.Interface {
  functions: {
    ...
    "manualBurn(address,uint256)": FunctionFragment;
    "manualMint(address,uint256)": FunctionFragment;
    "mintAndSend(address,uint256)": FunctionFragment;
...
export interface GoingUpReputationScore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoingUpReputationScoreInterface;
